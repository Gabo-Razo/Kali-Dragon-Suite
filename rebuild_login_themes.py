...
ALL_COLORS = {
    "red": {"hex": "#ec0101", "primary": "#ff1744", "hover": "#ff5252", "dark": "#8a0000", "glow": "rgba(255, 23, 68, 0.50)", "rgb": (255, 23, 68), "fg": "#ffffff"},
    "purple": {"hex": "#aa00ff", "primary": "#d500f9", "hover": "#e040fb", "dark": "#6a0080", "glow": "rgba(213, 0, 249, 0.50)", "rgb": (213, 0, 249), "fg": "#ffffff"},
    "green": {"hex": "#00c853", "primary": "#00e676", "hover": "#69f0ae", "dark": "#006020", "glow": "rgba(0, 230, 118, 0.50)", "rgb": (0, 230, 118), "fg": "#121317"},
    "blue": {"hex": "#2979ff", "primary": "#00b0ff", "hover": "#40c4ff", "dark": "#003c99", "glow": "rgba(0, 176, 255, 0.50)", "rgb": (0, 176, 255), "fg": "#ffffff"},
    "yellow": {"hex": "#ffc107", "primary": "#ffd600", "hover": "#ffe57f", "dark": "#806000", "glow": "rgba(255, 214, 0, 0.50)", "rgb": (255, 214, 0), "fg": "#121317"},
    "orange": {"hex": "#ff5722", "primary": "#ff6d00", "hover": "#ff9e80", "dark": "#802b00", "glow": "rgba(255, 109, 0, 0.50)", "rgb": (255, 109, 0), "fg": "#ffffff"},
    "lime": {"hex": "#64dd17", "primary": "#76ff03", "hover": "#b2ff59", "dark": "#33691e", "glow": "rgba(118, 255, 3, 0.50)", "rgb": (118, 255, 3), "fg": "#121317"},
    "pink": {"hex": "#f50057", "primary": "#ff4081", "hover": "#ff80ab", "dark": "#880e4f", "glow": "rgba(255, 64, 129, 0.50)", "rgb": (255, 64, 129), "fg": "#ffffff"},
    "cyan": {"hex": "#00e5ff", "primary": "#18ffff", "hover": "#84ffff", "dark": "#006080", "glow": "rgba(24, 255, 255, 0.50)", "rgb": (24, 255, 255), "fg": "#121317"},
    "white": {"hex": "#f5f5f5", "primary": "#ffffff", "hover": "#ffffff", "dark": "#424242", "glow": "rgba(255, 255, 255, 0.60)", "rgb": (255, 255, 255), "fg": "#121317"},
    "gold": {"hex": "#ffd700", "primary": "#ffab00", "hover": "#ffd54f", "dark": "#7f5500", "glow": "rgba(255, 171, 0, 0.50)", "rgb": (255, 215, 0), "fg": "#121317"},
    "indigo": {"hex": "#3d5afe", "primary": "#536dfe", "hover": "#8c9eff", "dark": "#1a237e", "glow": "rgba(83, 109, 254, 0.50)", "rgb": (61, 90, 254), "fg": "#ffffff"},
    "mint": {"hex": "#00bfa5", "primary": "#64ffda", "hover": "#a7ffeb", "dark": "#004d40", "glow": "rgba(100, 255, 218, 0.50)", "rgb": (0, 191, 165), "fg": "#121317"},
    "ruby": {"hex": "#c2185b", "primary": "#e91e63", "hover": "#ff4081", "dark": "#560027", "glow": "rgba(233, 30, 99, 0.50)", "rgb": (194, 24, 91), "fg": "#ffffff"},
    "silver": {"hex": "#cfd8dc", "primary": "#eceff1", "hover": "#ffffff", "dark": "#37474f", "glow": "rgba(236, 239, 241, 0.50)", "rgb": (207, 216, 220), "fg": "#121317"}
}
...
/* 2. UNIVERSAL LIGHTDM CONFIRM / SUBMIT BUTTON (Zero Blue Override) */
#login_button,
button#login_button,
...
print("SUCCESS: Rebuilt all 15 LightDM & Lockscreen themes with zero blue overrides and perfect contrast!")
